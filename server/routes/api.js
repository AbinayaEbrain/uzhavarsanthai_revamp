   ...
   await Phone.update(
    ...
    res.status(200).json({ message: 'Updated '});
     var options = {
      ...
      "port": null,
      "path": "/api/sendotp.php?authkey=281512AFLCJdJzg5d087aef&sender=UZHAVAN&otp_expiry=1&otp=" + contactData.otp + "&mobile=" + contactData.phone1,
      "headers": {}
    };
  ...
  if (exuser == null) {
    phoneVerify.save((error, registeredUser) => {
      ...
      var options = {
        ...
        "hostname": "control.msg91.com",
        "port": null,
        "path": "/api/sendotp.php?authkey=281512AFLCJdJzg5d087aef&sender=UZHAVAN&otp_expiry=1&otp=" + contactData.otp + "&mobile=" + contactData.phone,
        "headers": {}
      };
      // /api/sendotp.php?authkey=267433AasRmmBdVC5c8a1c2b&otp_expiry=1&otp=" + req.body.phone + "&mobile=" + req.body.phone **** "path": "/api/sendotp.php?otp_length=4&authkey=267433AasRmmBdVC5c8a1c2b&message=Your verification code is&sender=ABCDEF&mobile=919677424386&otp=1234&otp_expiry=1440",
...
router.post('/sendordersmstoseller',(req , res) => {
  ...
  var options = {
        ...
        "&authkey=281512AFLCJdJzg5d087aef&message=Hai%20"+
...
router.post('/sendSmsToSeller',(req , res) => {
  ...
  var options = {
        ...
        "hostname": "api.msg91.com",
        "port": null,
        "path": "/api/sendhttp.php?route=4&sender=UZHAVA&mobiles=" + signupData.phone + "&authkey=281512AFLCJdJzg5d087aef&message=Hai!%20You%20have%20been%20activated%20successfully%20by%20Uzhavarsanthai.%20You%20can%20login%20now.%20Connect%20with%20us%20and%20Do%20The%20Miracles%20in%20Agriculture!!!&country=91",
        "headers": {}
      };
